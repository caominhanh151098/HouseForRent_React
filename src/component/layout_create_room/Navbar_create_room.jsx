...
function Navbar_create_room  (){
  ...
  return (
    ...
    <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
      ...
      <a className="me-3 mt-3 py-2 text-dark text-decoration-none" href="#">Hỗ trợ</a>
      <div><Link className="" to={''}> <button onClick={handleCreateHouse} className='btn bg-dark text-white me-5 mt-3' >lưu và thoát</button></Link></div>
    </nav>
  </div></div>
  )
}export default Navbar_create_room
