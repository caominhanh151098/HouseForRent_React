  ...
  return (
    <div>
      <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        <Link to={"/bookedToday"} className="d-flex align-items-center text-dark text-decoration-none">
        ...
        <div className='d-flex justify-content-between col-5 ' style={{ marginLeft: '220px' }}>
          <Link className="" to={'/BookedToday'}><div> Hôm nay</div> </Link>
          <div>Hộp thư đến</div>
          <Link className="" to={'/calendar'}><div> Lịch</div> </Link>
          <Link className="" to={'/revenueHost'}><div>Lịch sử giao dich</div> </Link>
          <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              Menu
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><Link class="dropdown-item" to={"/firstCreateRoom"}>Tạo mục cho thuê mới</Link></li>
              <li><Link class="dropdown-item" to={"/homeList"}>Nhà / Phòng cho thuê</Link></li>
              <li><Link class="dropdown-item" to={"/reviews"}>Đánh giá của khách hàng</Link></li>            </ul>
          </div>
        </div>
