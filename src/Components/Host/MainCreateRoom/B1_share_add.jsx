  ...
  return (
    <>
      ...
      <div className='d-flex'>
        ...
        <div className='col-4'>
          <video autoPlay className='m-4 w-100' src='https://res.cloudinary.com/didieklbo/video/upload/f_auto:video,q_auto/v1/Gif/qwvodfdfxrj4vdobp0oa'></video>
        </div>
      </div>
      <div className='fixed-bottom d-flex justify-content-between'>
        <Link className="btn btn-sm ms-5 ms-5 mb-5 fs-5" to={'/'}>
          <i className="fa fa-arrow-left me-2" />quay lại
        </Link>
