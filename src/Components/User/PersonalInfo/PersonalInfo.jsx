                    ...
                    </div>
                    {
                        editState.isEditNameOpen && (
                            <div className='div-edit-first-last-name'>
                                ...
                                <div>
                                    {isEmpty.firstName && <p className="error-message"><i class="fa-solid fa-circle-exclamation"></i> Bắt buộc phải điền tên</p>}
                                    {isEmpty.lastName && <p className="error-message"><i class="fa-solid fa-circle-exclamation"></i> Bắt buộc phải điền họ</p>}
                                    {
                                        isSaveLoading ? (
                                            <div class="loadingio-spinner-ellipsis-ilx1jirdsl"><div class="ldio-qk6putkpoq">
                        ...
                        editState.isEditEmailOpen && (
                            <div className='div-edit-email'>
                                ...
                                <div>
                                    ...
                                    {isEmpty.email && <p className="error-message"><i class="fa-solid fa-circle-exclamation"></i> Địa chỉ email không được để trống</p>}
                                    {
                                        isSaveLoading ? (
                                            <div class="loadingio-spinner-ellipsis-ilx1jirdsl"><div class="ldio-qk6putkpoq">
                                                <div></div><div></div><div></div><div></div><div></div>
