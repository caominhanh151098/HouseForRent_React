...
const useFetchHousesReportLastMonth = () => {
    ...
    useEffect(() => {
        async function getData() {
            const responses = await axios.get(API_ADMIN + `houses/report?date1=${startDate}&date2=${endDate}`);
...
export default useFetchHousesReportLastMonth;